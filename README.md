...
- Layout tuning is entered from the console and uses edge buttons on a two-column snapping grid.
- Exiting layout tuning returns to the unlocked console view.
- Layout normalization prevents overlapping blocks while allowing floating blocks.
